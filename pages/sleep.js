    ...
    <div className={styles.container}>
      ...
      <div className="container-fluid d-flex">
        ...
        <div className="cartoon hb">
          ...
          <div className="front-gate ha">
            ...
            <div className="col-6">
               <div className="focusarea row h-100">
                <div className="row pb-2 gx-0">
                ...
                <div className="col-auto p-0 align-self-end text-end">
                <div className="status">Poor</div>
                </div>
                </div>
                <div className="row area-name gx-0">
                    <h2 className="p-0">Magnesium</h2>
                </div>
                <div className="row warning gx-0">
                    Low magnesium can lead to bad quality sleep
                </div>
            ...
            <div className="col-6">
               <div className="focusarea row h-100">
                ...
                <div className="row area-name gx-0">
                    <h2 className="p-0">Sleep Consistensy</h2>
                </div>
                <div className="row warning gx-0">
                    Low magnesium can lead to bad quality sleep
                </div>
            ...
            <div className="col-6">
               <div className="focusarea row h-100">
                ...
                <div className="row area-name gx-0">
                    <h2 className="p-0">Sleep Quality</h2>
                </div>
                <div className="row warning gx-0">
                    Low magnesium can lead to bad quality sleep
                </div>
      ...
      .window {
        ...
        box-shadow: 2.25vmin 0, 8vmin 0, 10.25vmin 0, 24vmin 0, 26.125vmin 0,
          ...
          /* small right tower windows */ 32.125vmin 1.5vmin 0 -0.125vmin,
          33.66vmin 1.5vmin 0 -0.125vmin,
          /* tower windows */ 0.25vmin -3.66vmin 0 -0.125vmin,
